...
const editGuardianButtons = document.querySelectorAll(".editar_documento");
editGuardianButtons.forEach(button => {
    button.addEventListener("click", () => {
        const id = button.getAttribute("data-id");
    ...
    // Exibe a section do formulário e oculta as outras
    showSection('novo_contrato');
    });
});
function Editar_documento(button) {
    // Pegando os valores dos atributos data-* do botão
    

    // Atualiza o título do formulário, se quiser
