...
const handleSubmitEncarregado = async (event) => {
...
// Adiciona o evento de submissão para o formulário de encarregado
formEncarregado.addEventListener('submit', handleSubmitEncarregado);



const form = document.getElementById('form-edit-student');
    // Função para lidar com a submissão do formulário via AJAX
    const handleSubmitEstudante = async (event) => {
        event.preventDefault(); // Previne o envio normal do formulário
        ...
        try {
            ...
            if (!result.sucesso) {
                ...
                // Caso tudo esteja certo, você pode redirecionar ou atualizar a página
...
// Adiciona o evento de submissão para o formulário de estudante
formEstudante.addEventListener('submit', handleSubmitEstudante);