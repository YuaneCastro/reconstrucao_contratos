...
document.addEventListener("DOMContentLoaded", () => {
    ...
    editGuardianButtons.forEach(button => {
        button.addEventListener("click", () => {
            ...
            atualizarVisibilidadeCurso("classe", "cursoContainer", "curso");
            if (curso) {
            ...
            function displayStudentData(studentData) {
                ...
                document.getElementById("editar-id-estudante").value = studentData.id;
                document.getElementById("nome").value = studentData.nome;
                document.getElementById("classe").value = studentData.classe;
                document.getElementById("turma").value = studentData.turma;
            
                // Verifica se deve mostrar o campo de curso
                if (["10ª Classe", "11ª Classe", "12ª Classe", "13ª Classe"].includes(studentData.classe)) {
                    document.getElementById("cursoContainer").style.display = "block";
                    document.getElementById("curso").value = studentData.curso || '';
                    document.getElementById("curso").setAttribute("required", "true");
                } else {
                    document.getElementById("cursoContainer").style.display = "none";
