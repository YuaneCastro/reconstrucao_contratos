...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const formulario = document.getElementById("formulario"); // coloque o id no seu form
    const submitButton = document.getElementById("submit-button"); // coloque um id no seu botão
    ...
    // Desabilitar no carregamento inicial
    submitButton.disabled = true;
});
