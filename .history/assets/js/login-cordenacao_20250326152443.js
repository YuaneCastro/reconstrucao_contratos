...
const data = await response.json(); // Agora é seguro tentar pegar o JSON
        if (response.ok && data.success) {
            alert("Login bem-sucedido!");            window.location.href = "/dashboard-cordenacao"; // Redireciona após sucesso
        } else {
