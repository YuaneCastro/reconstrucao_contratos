document.addEventListener('DOMContentLoaded', () => {
    // Primeiro, verifica a role e faz o que precisa
  if (window.userRole === "secretaria") {
    // Remove as divs proibidas (se existirem)
    ["logs", "novo_contrato", "dashboard"].forEach(id => {
      const el = document.getElementById(id);
      if (el) el.style.display = "none";
    });

    // Ativa a div que deve estar ativa para secretaria
    // Primeiro, tira a classe 'active' de todas as sections
    document.querySelectorAll("section").forEach(sec => sec.classList.remove("active"));
    // Depois, adiciona 'active' só na div da secretaria
