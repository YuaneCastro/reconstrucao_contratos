function showSection(sectionId) {
    ...
    // Mostrar ou esconder o campo de curso ao selecionar a classe
    ...
    // Validação dos campos para ativar/desativar botão
    ...
    // Função obrigatória para não quebrar o HTML (pode retornar true aqui, já que o submit é controlado via JS)
    function validarFormulario() {
        return false;
    }
    
    // Submissão assíncrona com Fetch
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (resposta.ok) {
                ...
                // Pequeno efeito de fade (opcional)
