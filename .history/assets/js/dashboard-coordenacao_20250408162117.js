...
document.addEventListener("DOMContentLoaded", () => {
    ...
    editGuardianButtons.forEach(button => {
        button.addEventListener("click", () => {
            ...
            alert("ID do encarregado: " + id);
alert("Nome do encarregado: " + nome);
            ...
            alert("ID no campo oculto:"document.getElementById("editar-id").value);
      ...
      document.getElementById("form-editar").addEventListener("submit", function(event) {
        ...
        fetch("/update_encarregado", {
            ...
            body: JSON.stringify({ nome, email, telefone }) // Envia os dados em JSON
        })
