    document.getElementById("enviarBtn").addEventListener("click", async function() {
        ...
        const mensagem = document.getElementById("confirmError");
    ...
    document.getElementById("confirmarBtn").addEventListener("click", async function (event) {
        ...
        try {
            ...
            if (response.ok && data.success) {
                ...
                window.location.href = '/dashboard-cordenacao'; // /dashboard-secretaria
            ...
            mensagem.textContent = "Erro ao confirmar. Tente novamente.";
        } finally {
