...
formEncarregado.addEventListener("submit", async (event) => {
    ...
    const validarTelefone = (telefone) => {
        const regex = /^[0-9]{10,15}$/; // Aceita números de 10 a 15 dígitos
    ...
    // Exibir os dados coletados no console para debug
    ...
    try {
        ...
        console.error('Erro ao atualizar o encarregado:', error);
