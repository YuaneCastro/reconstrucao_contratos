...
function formatTime(seconds) {
  const minutes = Math.floor(seconds / 60); // Divisão correta para minutos
  const remainingSeconds = seconds % 60; // Resto para segundos
...
function startTimer() {
  ...
  timerInterval = setInterval(() => {
    countdownTime--; // Decrementa o tempo a cada segundo
