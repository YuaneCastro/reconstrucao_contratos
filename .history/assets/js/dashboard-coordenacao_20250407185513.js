...
function usarEncarregado(element) {
    const encarregado = {
    ...
    // Preenche os inputs
    document.getElementById('encarregado_nome').value = encarregado.nome;
    document.getElementById('encarregado_email').value = encarregado.email;
    document.getElementById('telefone').value = encarregado.telefone;

    // Esconde a div de lista e mostra o formulário
