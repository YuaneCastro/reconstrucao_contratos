document.addEventListener("DOMContentLoaded", function () {
    // Primeira coisa: verifica role e ajusta a classe se for secretaria
    if (window.userRole === "secretaria") {
      const secretariaSection = document.querySelector('.secretaria');
      if (secretariaSection) {
        // Remove a classe 'section active' de onde estiver
        document.querySelectorAll('.section.active').forEach(el => {
          el.classList.remove('active');
        });
        // Adiciona a classe para secretaria
        secretariaSection.classList.add('active');
      }
    }
  
    // Aqui seu código antigo, tudo dentro do DOMContentLoaded, sem alteração
    // Exemplo:
