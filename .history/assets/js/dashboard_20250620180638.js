...
function handleViewContract(button) {
  ...
  const documento_id = button.getAttribute('data-documento-id')
  ...
  if (tipo.toLowerCase() === 'contrato') {
    html += `
      <div style="text-align: center; margin-top: 30px;">
        ...
        <img src="/assets/images/assinar.png" style="width:20px; height:20px; margin-right:5px;">  Assinar Contrato
        </button>
      </div>`;
  }
