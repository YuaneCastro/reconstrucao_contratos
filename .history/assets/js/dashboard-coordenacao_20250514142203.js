...
function Editar_documento(botao) {
    // Pega dados dos atributos data-*
    const id = botao.getAttribute('data-id');
    const tipo = botao.getAttribute('data-tipo');
    const titulo = botao.getAttribute('data-titulo');
    const descricao = botao.getAttribute('data-descricao');
    const dataExpiracao = botao.getAttribute('data_expiracao');
  
    // Define valor nos campos do formulário
    document.getElementById('tipoDocumento').value = tipo;
    document.getElementById('titulo').value = titulo;
    document.getElementById('conteudo').value = descricao;
    document.getElementById('dataExpiracao').value = dataExpiracao;
  
    // Troca título do formulário para 'Editar Documento'
    document.getElementById('formTitle').textContent = 'Editar Documento';
  
    // Salva o id do contrato em edição
    contratoEditandoId = id;
  
    // Mostra a seção de novo contrato
    document.getElementById('dashboard').classList.remove('active');
    document.getElementById('novo_contrato').classList.add('active');
  }
