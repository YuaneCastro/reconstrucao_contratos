...
editdocumento.forEach(button => {
    ...
    const data-enviar_para_todos = button.getAttribute("data-categorias");
    const dataExpiracao = button.getAttribute("data-enviar_para_todos");

    data_expiracao="<%= doc.data_expiracao ? new Date(doc.data_expiracao).toLocaleDateString('pt-BR') : 'Sem data' %>"
                      data-categorias='<%= JSON.stringify(doc.categorias) %>'
                      data-enviar_para_todos="<%= doc.enviar_para_todos %>"
