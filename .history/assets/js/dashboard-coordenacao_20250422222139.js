...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function atualizarVisibilidadeCurso_atualizar(classeSelecionada, cursoSelecionado = ""){
        ...
        if (classesComCurso.includes(classeSelecionada) && cursoSelecionado) {
            container.style.display = "block";
            campoCurso.value = cursoSelecionado;
        } 
        // Se a classe for elegível mas o curso for null, esconde
        else if (classesComCurso.includes(classeSelecionada) && !cursoSelecionado) {
            container.style.display = "none";
            campoCurso.value = "";
        } 
        // Se a classe não exige curso
        else {
            container.style.display = "none";
            campoCurso.value = "";
        }
