...
function verificarClasse2() {
    ...
    alert(document.getElementById("classe2").value)
...
function validarFormulario() {
    ...
    alert(getElementById("curso2").value)
    alert(document.getElementById("turma2").value)
    

    if (!nome || !email || !telefone || !classeSelecionada || !curso || !turma) {
        return false;
    }
