...
function coletarDadosContrato() {
    const id_documento_el = document.getElementById('documentoId');
    const id_documento = id_documento_el ? id_documento_el.value : null;
...
document.getElementById('#novo_contrato #botao_guardar').addEventListener('click', async function(event) {
    event.preventDefault();
...
document.getElementById('#novo_contrato #botaoSubmit').addEventListener('click', async function(event) {
    event.preventDefault();
    const dados = coletarDadosContrato();
