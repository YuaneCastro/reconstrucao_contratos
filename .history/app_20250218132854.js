...
app.use(session({
    secret: 'seu-segredo', // Escolha uma chave secreta segura
    resave: false,         // Não resave a sessão se ela não foi modificada
    ...
    cookie: { 
        ...
        maxAge: 24 * 60 * 60 * 1000 // Define o tempo de expiração para 1 dia
    }
}));
