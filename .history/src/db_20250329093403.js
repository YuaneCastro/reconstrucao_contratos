...
const encarregado = async (nome, email, telefone) => {
    const result =await pool.query('SELECT * FROM encarregados WHERE nome = $1 AND email = $2 AND telefone = $3'[nome, email, telefone]);
