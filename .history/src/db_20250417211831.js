...
const guardar_documento = async (tipo, titulo, descricao, especificacoes, enviarParaTodos) => {
    const result = pool.query(`INSERT INTO documentos (tipo, titulo, descricao)
            VALUES ($1, $2, $3) RETURNING id`,[tipo, titulo, descricao]);
    ...
    if (enviarParaTodos) {
        ...
        // Inserir cada especificação normalmente
