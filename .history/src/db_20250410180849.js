...
const eliminar_log = async (pool, id) => {
...
const eliminar_dos_tokens = async (pool, id) => {
    const client = await pool.connect();
    try {
...
const eliminar_estudantes = async (pool, id) => {
    const client = await pool.connect();
    try {
...
const eliminar_encarregado = async (pool, id) => {
    const client = await pool.connect();
    try {
...
const eliminar_tudo = async (id) => {
    ...
    try {
        ...
        await eliminar_log(pool, id);
        await eliminar_dos_tokens(pool, id);
        await eliminar_estudantes(pool, id);
        await eliminar_encarregado(pool, id);
