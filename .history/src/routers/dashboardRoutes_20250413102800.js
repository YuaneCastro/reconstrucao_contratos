...
router.get('logout_encarregado', authenticateToken, authorizeRole, telapCont.logout_encarregado);

// -----------coordenacao--------------
router.get('logout_coordenacao', authenticateToken, authorizeRole('coordenador'), telapCont.logout_coordenacao);
