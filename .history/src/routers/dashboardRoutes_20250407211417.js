...
router.post('update_student', authenticateToken, authorizeRole('coordenador'), telapCont.updat_eStudent);
router.post('update_student', authenticateToken, authorizeRole('coordenador'), telapCont.update-encarregado);
