                ...
                if (tipo === 'contrato') {
                    if (estudantesResult.rows.length > 0) {
                        for (const estudante of estudantesResult.rows) {
                            ...
                            await sendEmail(encarregadoEmail, tipo, titulo, descricao, dataExpiracao, estudanteId);
                        }
                    }
                } else {
...
const sendEmail = async (encarregadoEmail, tipo, titulo, descricao, dataExpiracao, estudanteId) => {
    const mailOptions = {
