...
const enviar_documento = async (tipo, titulo, descricao, especificacoes, enviarParaTodos, dataExpiracao, id=) => {
    try {
        const result = await pool.query(`
...
const guardar_documento = async(tipo, titulo, descricao, especificacoes, enviarParaTodos, dataExpiracao) => {
