...
const verifyUserLogin = async(email, senha)=>{
    try {
        ...
        const senhaDigitada = "123"; // Substitua pela senha real
        const hashSalvo = "$2b$10$4vPtGtaz81mcVNPZnVqXXehEIm6rleRN9dZUnTQreoqwjuA8KIG66"; // Copie um hash do banco
        ...
        / 🔥 Aqui garantimos que bcrypt já foi importado antes
        const isPasswordValid = bcrypt.compareSync(senha.trim(), user.senha_hash.trim());
