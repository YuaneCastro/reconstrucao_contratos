...
const criarEncarregado = async (nome, email, telefone) => {
    const result = await pool.query(
        'INSERT INTO encarregados (nome, email, telefone, codigo_verificacao, codigo_expiracao) VALUES ($1, $2, $3, $4, $5) RETURNING id',
        [nome, email, telefone, null, null]
    );
...
// envia o email de redefinicao para o encarregado digitar a sua senha
...
estudanteExiste,buscarEncarregadoPorEmail,criarEncarregado,cadastrarEstudanteNoBanco,gerarTokenRedefinicao,enviarEmailRedefinicao
