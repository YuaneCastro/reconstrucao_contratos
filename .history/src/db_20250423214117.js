            ...
            for (const row of encResult.rows) {
                ...
                await pool.query(
                    `INSERT INTO log_atividades (encarregado_id, acao, detalhes)
                     VALUES ($1, $2, $3)`,
                    [row.id, 'Envio de documento', `Documento '${titulo}' enviado para encarregado (todos)`]
                );
            }
        } else {
                ...
                for (const r of res.rows) {
                    ...
                    await pool.query(
                        ...
                        [
                            ...
                            r.estudante_id,
                            'Envio de documento',
                            `Documento '${titulo}' enviado para curso=${curso || 'todos'}, classe=${classe}, turma=${turma || 'todos'}`
                        ]
                    );
                }
            }
