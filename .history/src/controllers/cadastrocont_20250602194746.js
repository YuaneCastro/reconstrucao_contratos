...
exports.setPassword = async (req, res) => {
    ...
    try {
        ...
        await logEvent(encarregado_id, null, 'redifinir senha', 'Todos os registros ligados ao encarregado foram eliminados.');
