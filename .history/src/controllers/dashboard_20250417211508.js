...
exports.enviar_documento = async (req, res) => {
    ...
    try{
        await guardar_documento(dadosContrato.tipoDocumento, dadosContrato.titulo, dadosContrato.conteudo,  dadosContrato.especificacoes, dadosContrato.enviarParaTodos);
