const { buscar_email,bu, buscarEncarregadoPorTelefone,buscarEncarregadoPorNome,buscaridestudante,logEvent,buscarToken, adicionar_senha, deletarToken, estudanteExiste, buscarEncarregadoPorEmail, criarEncarregado, gerarTokenRedefinicao, cadastrarEstudanteNoBanco } = require('../db');
