...
exports.cadastrar = async (req, res) => {
    ...
    try {
        ...
        if (await estudanteExiste(nome)) {
         ...
         // Busca se já existe encarregado com email, telefone ou nome
        ...
        if (encarregadoEmail || encarregadoTelefone || encarregadoNome) {
            if (encarregadoEmail && encarregadoTelefone && encarregadoNome &&
                encarregadoEmail.id === encarregadoTelefone.id && encarregadoTelefone.id === encarregadoNome.id
            ) {
         ...
         if (encarregado) {
            ...
            let encarregadoId = await criarEncarregado(encarregado_nome, encarregado_email, telefone);
