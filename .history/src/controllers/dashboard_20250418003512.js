...
exports.enviar_documento = async (req, res) => {
    ...
    try{
        await guardar_documento_e_enviar(dadosContrato.tipoDocumento, dadosContrato.titulo, dadosContrato.conteudo,  dadosContrato.especificacoes, dadosContrato.enviarParaTodos);
        return res.status(200).json({
            sucesso: true,
...
exports.showtelap = async (req, res) => { 
    try {
        ...
        const log_atividade = await buscarDocumentosDoEncarregado(id);
