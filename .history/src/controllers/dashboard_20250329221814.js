...
const { lista_encarregados, ogEvent, estudanteExiste, criarEncarregado, gerarTokenRedefinicao, cadastrarEstudanteNoBanco  ,lista_estudantes, findEmail, buscar_logs, find_cordenacao } = require('../db');
