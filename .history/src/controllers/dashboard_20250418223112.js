...
exports.enviar_documento = async (req, res) => {
    ...
    try{
        await guardar_documento_e_enviar(dadosContrato.tipoDocumento, dadosContrato.titulo, dadosContrato.conteudo,  dadosContrato.especificacoes, dadosContrato.enviarParaTodos, dadosContrato);
        return res.status(200).json({
            sucesso: true,
