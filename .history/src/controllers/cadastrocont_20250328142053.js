const { buscar_emailbusc, buscarEncarregadoPorTelefone,buscarEncarregadoPorNome,buscaridestudante,logEvent,buscarToken, adicionar_senha, deletarToken, estudanteExiste, buscarEncarregadoPorEmail, criarEncarregado, gerarTokenRedefinicao, cadastrarEstudanteNoBanco } = require('../db');
