const { findEmail,verifyUserLogin, deleteVerificationCode, saveVerificationCode, verifyVerificationCode} = require('../db');
...
exports.handleLogin = async (req, res) => {
    ...
    try {
        ...
        console.log("Hash da senha no banco:", senha_has);
