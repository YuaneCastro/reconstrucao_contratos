...
exports.handleLogin = async (req, res) => {
    ...
    try {
        ...
        // Não há redirecionamento para 'confirmlog', apenas retorna um status
        res.status(200).json({ message: 'Login bem-sucedido. Código de confirmação enviado para o seu e-mail.' });
    } catch (err) {
