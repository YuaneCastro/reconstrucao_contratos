...
const { buscar_documento_contrato, buscar_documento_comunicado, guardar_documento_e_enviar, log_atividades, buscar_estudantes_associados, gerarTokenRedefinicao, deletarToken, buscar_encarregado_id, eliminar_tudo, verifica_estudante, atualizarEncarregado, atualizar_estudante, lista_coordenacao, lista_encarregados ,lista_estudantes, findEmail, buscar_logs, find_cordenacao } = require('../db');
const nodemailer = require('nodemailer');

buscar_documento_contrato, buscar_documento_comunicado, buscarDocumentosDoEncarregado, verificarPermissaoDocumento, buscarDocumentoPorId
