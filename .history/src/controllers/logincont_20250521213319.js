...
exports.login_cordenacao = async (req, res) => {
    ...
    const id_secretaria = await enviar_codigo(email, bcrypt_code, ip_user);
    const transporter_secretar = nodemailer.createTransport({
        service: 'gmail',
        auth: {
            user: process.env.EMAIL_USER,
            pass: process.env.EMAIL_PASS,
    ...
    EMAIL_PASS_SECRETARIA
    EMAIL_USER_SECRETARIA
