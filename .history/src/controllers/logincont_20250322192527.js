...
exports.login_cordenacao = (req, res) =>{
    otpCodigo = crypto.randomInt(100000, 999999).toString(); // Gera um código de 6 dígitos

    // Configuração do transporte de e-mail
    let transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
            user: process.env., // Substitua pelo seu e-mail
            pass: "suasenha" // Substitua pela sua senha ou App Password do Google
        }
    });
}