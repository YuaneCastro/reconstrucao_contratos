...
exports.enviar_documento = async (req, res) => {
    ...
    try{
        await enviar_documento(dadosContrato.tipoDocumento, dadosContrato.titulo, dadosContrato.conteudo,  dadosContrato.especificacoes, dadosContrato.enviarParaTodos, dadosContrato.dataExpiracao);
        return res.status(200).json({
            sucesso: true,
