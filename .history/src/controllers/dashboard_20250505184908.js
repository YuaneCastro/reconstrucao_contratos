...
const { assinar_contrato_estudnate, getContratoPorId, buscarContratosPendentes, buscar_documento_contrato, buscar_documento_comunicado, buscarDocumentosDoEncarregado, guardar_documento_e_enviar, log_atividades, buscar_estudantes_associados, gerarTokenRedefinicao, deletarToken, buscar_encarregado_id, eliminar_tudo, verifica_estudante, atualizarEncarregado, atualizar_estudante, lista_coordenacao, lista_encarregados ,lista_estudantes, findEmail, buscar_logs, find_cordenacao } = require('../db');
...
exports.assinar_contrato = async (req, res) => {
    ...
    console.log(assinatura_doc_id, encarregado_id, estudante_id);
     const result = await assinar_contrato_estudnate(assinatura_doc_id, encarregado_id, estudante_id)
};