...
exports.dashboard_cordenacao = async(req,res) =>{
    try {
        ...
        res.render("dashboard/dashboard-cordenacao", { role:user.role,email: user.email, logs, encarregados, estudantes, coordenacao, comunicado, contrato, documentos, log_atividade_encarregados});
    } catch (error) {
