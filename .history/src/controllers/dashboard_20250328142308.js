...
const { buscarEncarregadoPorEmail, lista_encarregados, lista_estudantes, findEmail, buscar_logs, find_cordenacao } = require('../db');
...
exports.showtelap = async (req, res) => { 
    try {
        ...
        res.render("dashboard/dashboard", { nome: user.nome, email: user.email });
