...
const { eliminar_tudoverifica_estudante, atualizarEncarregado, atualizar_estudante, lista_coordenacao, lista_encarregados ,lista_estudantes, findEmail, buscar_logs, find_cordenacao } = require('../db');
...
exports.deletar = async(req, res) =>{
    ...
    try{
        ...
        return {
            sucesso: true,
            motivo: "Encarregado deletado com sucesso."
        };
    }catch(err){
        console.log(err);
    }
