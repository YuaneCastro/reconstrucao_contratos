...
exports.verifyCode = async (req, res) => {
    ...
    const tempToken = req.cookies.tempToken; // Pegando do cookie ANTES de usar
    ...
    try {
        const decoded = jwt.verify(tempToken, process.env.TOKEN_SECRET); // Usando a chave correta
