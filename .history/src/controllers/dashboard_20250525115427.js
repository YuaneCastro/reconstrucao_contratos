...
exports.dashboard_secretaria = async(req,res) =>{
    try {
        ...
        res.render("dashboard/dashboard-secretaria", {info_dashboardlogs, email: user.email, encarregados, estudantes, comunicado, contrato, log_atividade_encarregados});
    } catch (error) {
...
exports.dashboard_coordenacao = async(req,res) =>{
    try {
        const token = req.cookies.token;
        if (!token) {return res.redirect("/login-direcao")};
