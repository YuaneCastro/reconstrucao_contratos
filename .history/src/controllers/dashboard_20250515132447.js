...
exports.guardar_documentos = async(req, res) =>{
    ...
    console.log(dadosContrato.id_documento)
    try{
        await guardar_documento (dadosContrato.tipoDocumento, dadosContrato.titulo, dadosContrato.conteudo,  dadosContrato.especificacoes, dadosContrato.enviarParaTodos, dadosContrato.dataExpiracao, dadosContrato.id_documento)
