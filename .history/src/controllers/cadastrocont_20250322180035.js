const { logEvent,buscarToken, adicionar_senha, deletarToken, estudanteExiste, buscarEncarregadoPorEmail, criarEncarregado, gerarTokenRedefinicao, cadastrarEstudanteNoBanco } = require('../db');
...
exports.cadastrar = async (req, res) => {
    ...
    try {
        ...
        const id_estudante = await buscaridestudante(nome)
        await cadastrarEstudanteNoBanco(id_estudante, data_nascimento, classe, turma, curso, encarregadoId);
