const { findEmail, enviar_codigo, buscar_codigoUTP, deleteVerificationCode, saveVerificationCode, verifyVerificationCode} = require('../db');
...
exports.verificar_login_cordenacao = async (req,res) => {
    ...
    await buscar_codigoUTP(ip_user, email);
}