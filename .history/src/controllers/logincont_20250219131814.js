...
exports.verifyCode = async (req, res) => {
    ...
    console.log("Código recebido:", code); // Verifique se o código está chegando corretamente
    console.log("Email da sessão:", email); // Verifique se o email está na sessão
