...
async function buscarContratosPendentes(id) {
    const query = `
      SELECT ad.id AS assinatura_id, d.id AS documento_id, d.tipo, d.titulo, d.descricao, d.data_emissao, d.data_expiracao, ad.estudante_id, e.nome AS estudante_nome
      FROM documentos d
